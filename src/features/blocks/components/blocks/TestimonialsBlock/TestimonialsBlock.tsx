...
export const TestimonialsBlock: React.FC<TestimonialsBlockProps> = ({
  ...
  return (
    <section style={{ backgroundColor, color: textColor, padding: "var(--space-4xl) var(--space-xl)" }}>
        ...
        <div style={{
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p style={{ fontSize: "1.125rem", lineHeight: 1.6, marginBottom: "var(--space-xl)", flexGrow: 1, zIndex: 1 }}>
                &ldquo;{t.quote}&rdquo;
              </p>
              
              <div style={{ display: "flex", alignItems: "center", gap: "var(--space-md)", zIndex: 1 }}>
                {t.avatarUrl ? (
                  /* eslint-disable-next-line @next/next/no-img-element */
                  <img src={t.avatarUrl} alt={t.author} style={{ width: "48px", height: "48px", borderRadius: "50%", objectFit: "cover" }} />
                ) : (
                ...
                <div>
                  ...
                  {t.role && <div style={{ fontSize: "0.875rem", color: "var(--color-text-tertiary)" }}>{t.role}</div>}
                </div>
              </div>
            </div>
          ))}
